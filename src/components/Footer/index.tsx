    ...
    <footer className="w-full py-3 bg-[#90C9E1] border-t border-gray-200">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex space-x-6 mt-4 md:mt-0">
          ...
          <a href="https://github.com/larakrefski/lara-portfolio" target="_blank" rel="noopener noreferrer" className="text-[#141e22] hover:opacity-80 transition-colors transition-opacity">GitHub</a>
        </div>
      </div>
    </footer>
  );
